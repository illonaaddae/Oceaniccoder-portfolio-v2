...
export async function createEducation(edu: Omit<Education, "$id">): Promise<Education> {
...
export async function updateEducation(
  ...
  if (edu.achievement !== undefined) cleanedData.achievement = edu.achievement || null;
  if (edu.description !== undefined) cleanedData.description = edu.description || null;
  ...
  if (edu.classHonours !== undefined) cleanedData.classHonours = edu.classHonours || null;
  if (edu.startDate !== undefined) cleanedData.startDate = edu.startDate || null;
