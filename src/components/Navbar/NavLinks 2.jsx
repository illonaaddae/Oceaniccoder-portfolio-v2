...
import { NAV_BASE_CLASS, getNavActiveClass, getNavInactiveClass, lightStyle } from "./navData";
      ...
      {navItems.map((item) => {
        ...
        return isInternal ? (
          <NavLink
            ...
            className={({ isActive }) => `${NAV_BASE_CLASS} ${isActive ? activeCls : inactiveCls}`}
            style={style}
          >
            {item.label}
          </NavLink>
          ...
          <button
            ...
            className={`${NAV_BASE_CLASS} ${activeSection === item.id ? activeCls : inactiveCls}`}
            style={style}
          >
            {item.label}
          </button>
