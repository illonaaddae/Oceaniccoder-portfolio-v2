    ...
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {error && (
          <div
            className={`backdrop-blur-md border rounded-lg p-3 ${
              dk ? "glass-card bg-red-500/20 border-red-500/50" : "bg-red-50 border-red-200"
            }`}
          >
        ...
        {info && (
          <div
            className={`backdrop-blur-md border rounded-lg p-3 ${
              dk ? "bg-green-500/15 border-green-500/40" : "bg-green-50 border-green-200"
            }`}
          >
            <p className={`text-sm ${dk ? "text-green-100" : "text-green-700"}`}>{info}</p>
          </div>
        )}
