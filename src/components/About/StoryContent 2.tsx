    ...
    <div className="glass-card w-full p-4 sm:p-6 md:p-8 overflow-visible">
      ...
      <div className="space-y-3 sm:space-y-4 md:space-y-6 text-gray-300 leading-relaxed">
        <p className="text-story-lg">
          ...
          who taught me that strength isn't loud, it's consistent. After losing my father early, I
          learned resilience not as a choice, but as a way of life. That spirit shaped how I see the
        ...
        <p className="text-story-lg">
          ...
          <strong className="text-oceanic-500 text-strong">Oceaniccoder, </strong> I'm a constantly
          evolving developer, designer, and leader driven by purpose and curiosity. Whether I'm
          coding, designing a user experience, or mentoring someone new to tech, I build with
          empathy, intention, and vision. My journey isn't just about writing code. It's about
          writing change. One project, one person, one purpose at a time.
        </p>
      </div>
