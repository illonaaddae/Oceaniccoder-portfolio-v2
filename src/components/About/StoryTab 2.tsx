...
const StoryTab = React.memo(({ galleryImages, about, certifications }: StoryTabProps) => (
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-start">
    <StoryContent />
    <div className="space-y-5 sm:space-y-6 lg:space-y-8">
      {galleryImages && galleryImages.length > 0 && <ImageGallery galleryImages={galleryImages} />}
