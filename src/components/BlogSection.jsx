  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none" style={{ zIndex: 0 }}>
        <div className="liquid-morph absolute top-60 right-10 w-96 h-96 bg-gradient-to-r from-oceanic-500/8 to-oceanic-700/10 blur-3xl" />
        <div className="liquid-morph absolute bottom-20 left-10 w-80 h-80 bg-gradient-to-r from-oceanic-400/6 to-oceanic-600/8 blur-3xl" />
      </div>
