...
// Dark mode image (white shirt) - hosted on Appwrite
export const PROFILE_IMAGE_DARK_URL =
...
// Light mode image (black shirt) - served from public/images
export const PROFILE_IMAGE_LIGHT_URL = "/images/hero-img-dark.webp";

// Kept for backwards compat
export const PROFILE_IMAGE_URL = PROFILE_IMAGE_DARK_URL;
