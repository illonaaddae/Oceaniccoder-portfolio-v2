...
export const eventsJanMar: Event[] = [
  {
    ...
    message: "Wishing you an amazing year ahead filled with success and happiness!",
  ...
  },
  {
    id: "mlk-day",
    title: "MLK Day",
    message: "Honoring Dr. Martin Luther King Jr. and his dream of equality for all.",
  ...
  },
  {
    ...
    message: "Spreading love and appreciation to all visitors! Thanks for being here.",
  ...
  },
  {
    ...
    message: "Celebrating the achievements and contributions of Black Americans.",
  ...
  },
  {
    ...
    message: "Celebrating women's achievements and advocating for gender equality.",
