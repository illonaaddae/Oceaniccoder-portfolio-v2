...
export default function BookingSection() {
  ...
  const canProceedStep2 = form.meetingType && form.preferredDate && form.preferredTime;
    ...
    try {
      ...
      try {
        ...
        if (meetRes.status === 409) {
          ...
          setError(
            meetData.message || "That time slot is already booked. Please choose a different time.",
          );
          return;
        }
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-6xl">
        ...
        >
          ...
          >
            Let&apos;s <span style={{ color: "var(--accent-teal)" }}>Connect</span>
          </h1>
          <p className="text-lg max-w-xl mx-auto" style={{ color: "var(--text-secondary)" }}>
            Schedule a meeting that fits your needs no back-and-forth emails, no waiting. Just pick
            a slot and let&apos;s talk.
          </p>
        </motion.div>
        ...
        {step < 4 ? (
                  ...
                  {MEETING_TYPES.map((m) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <span className="text-xl" style={{ color: "var(--accent-teal)" }}>
                          {m.icon}
                        </span>
                      ...
                      >
                          ...
                          >
                            ...
                            <div>
                              ...
                              <p className="text-xs" style={{ color: "var(--text-secondary)" }}>
                                {MEETING_TYPES.find((m) => m.id === form.meetingType)?.duration} ·
                                Click left panel to change
                              </p>
                            </div>
                          </div>
                        )}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="grid grid-cols-3 gap-2">
                            {TIME_SLOTS.map((slot) => {
                              const isBooked =
                                slotAvailability[slot] === false || appwriteBookedSlots.has(slot);
          ...
          >
            ...
            >
              ...
              <div className="rounded-xl p-4 mb-6" style={{ background: "var(--bg-secondary)" }}>
