  ...
  return (
    <>
      {activeTab === "overview" && (
        <OverviewTab
          theme={theme}
          totalProjects={searchQuery ? props.filteredProjects.length : props.totalProjects}
          filteredSkills={props.filteredSkills}
          totalCertifications={
            searchQuery ? props.filteredCertifications.length : props.totalCertifications
          }
      ...
      {activeTab === "comments" && <CommentsTab theme={theme} isReadOnly={isReadOnly} />}
      {activeTab === "skills" && (
        <SkillsTab
          theme={theme}
          loading={loading}
