  ...
  >
    ...
    {uploading ? (
      <div className="flex flex-col items-center gap-2">
        <svg className="w-8 h-8 text-oceanic-500 animate-spin" fill="none" viewBox="0 0 24 24">
          <circle
      ...
      <div className="flex flex-col items-center gap-2">
        <div className="flex items-center gap-2">
          <FaImage className={`w-6 h-6 ${theme === "dark" ? "text-gray-500" : "text-slate-400"}`} />
          {allowPdf && (
            <FaFilePdf
              className={`w-6 h-6 ${theme === "dark" ? "text-gray-500" : "text-slate-400"}`}
            />
          )}
        </div>
