import type { Skill, Project, Certification, GalleryImage, Education, Journey } from "@/types";
...
interface SubmitHandlersDeps {
  ...
  handleUpdateProject: (id: string, data: Omit<Project, "$id">) => Promise<void>;
  ...
  handleUpdateCertification: (id: string, data: Omit<Certification, "$id">) => Promise<void>;
  handleAddEducation: (data: Omit<Education, "$id">) => Promise<void>;
  handleUpdateEducation: (id: string, data: Omit<Education, "$id">) => Promise<void>;
  handleAddJourney: (data: Omit<Journey, "$id">) => Promise<void>;
  handleUpdateJourney: (id: string, data: Omit<Journey, "$id">) => Promise<void>;
  handleAddGalleryImage: (data: Omit<GalleryImage, "$id">) => Promise<void>;
  handleUpdateGalleryImage: (id: string, data: Omit<GalleryImage, "$id">) => Promise<void>;
