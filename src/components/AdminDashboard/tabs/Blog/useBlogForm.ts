...
import { createTagHandlers, createImageInserter, filterPosts } from "./formHelpers";
...
export function useBlogForm(
  ...
  const handleSubmit = (e: React.FormEvent) =>
    submitAction(e, modal.formData, modal.editingPost, modal.closeModal, setSubmitting);
  ...
  return {
    ...
    handleSubmit,
    handleDelete,
    sendTestNewsletter: () => sendTestNewsletter(modal.formData),
