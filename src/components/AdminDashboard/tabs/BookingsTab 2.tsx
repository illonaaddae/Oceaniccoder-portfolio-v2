              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 flex-wrap mb-2">
                    ...
                    <span
                      className={`text-xs px-2.5 py-1 rounded-full border font-medium ${STATUS_STYLES[b.status] ?? STATUS_STYLES.pending}`}
                    >
                      {b.status ?? "pending"}
                    </span>
                    <span
                      className={`text-xs px-2.5 py-1 rounded-full border font-medium ${isDark ? "bg-oceanic-500/20 text-oceanic-400 border-oceanic-500/30" : "bg-blue-50 text-blue-700 border-blue-200"}`}
                    >
