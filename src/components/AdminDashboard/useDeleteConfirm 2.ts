...
const READONLY_MSG = "This feature is for admin only. You are viewing in read-only mode.";
...
export function useDeleteConfirm(
  ...
  handleStatusChange: (id: string, status: "new" | "read" | "replied") => Promise<void>,
  loadData: (showLoader?: boolean) => Promise<void>,
) {
  const [deleteConfirm, setDeleteConfirm] = useState<DeleteConfirmState>(EMPTY_STATE);
