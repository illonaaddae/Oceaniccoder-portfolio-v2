...
const AboutSection = () => {
  ...
  return (
    <section
      id="about"
      className="min-h-[auto] sm:min-h-dvh pt-28 sm:pt-28 pb-12 sm:pb-20 relative scroll-mt-24 sm:scroll-mt-28"
      style={{
    ...
    >
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn about Illona Addae, software and AI engineer, tech leader, and mentor. Passionate about building impactful digital products."
        />
